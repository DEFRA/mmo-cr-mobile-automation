...
- Specs live in `test/ios/specs/` and `test/android/specs/`. Page objects in `test/<platform>/pageobjects/`. Reusable journey helpers in `test/<platform>/support/*FlowNavigator.ts`.
